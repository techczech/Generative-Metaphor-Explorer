      ...
      <article className="max-w-prose mx-auto">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-slate-700 text-lg leading-relaxed">
            <p>
              The Generative Metaphor Explorer is an interactive application designed to help you deconstruct and understand conceptual metaphors. By inputting a metaphor (e.g., "AI is an intern"), the tool uses a powerful AI model to:
            </p>
        ...
        <section>
          ...
          <div className="space-y-4 text-slate-700 text-lg leading-relaxed">
            ...
            <p>
             ...
             <p>
              The core analysis is powered by <strong className="font-semibold text-slate-800">Gemini 2.5 Pro</strong>, Google's state-of-the-art large language model, which provides the nuanced understanding required to deconstruct and explore metaphorical mappings.
            </p>
          </div>
        </section>
      </article>
